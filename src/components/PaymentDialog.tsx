            ...
            {paymentMethod === 'yoomoney' ? (
              <Button
                ...
                onClick={async () => {
                  ...
                  const yooUrl = `https://yoomoney.ru/transfer/quickpay?receiver=4100118960048082&quickpay-form=link&targets=${encodeURIComponent(formData.telegram + ' — ' + service)}&sum=${numAmount}&label=${encodeURIComponent(formData.telegram)}`;
                  try {
